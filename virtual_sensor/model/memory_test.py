...
metrics_output_path = "/Users/wangyangyang/Desktop/Finland/summer_job/home_kitchen/level_3/processed_files/metrics_per_label——test.csv"
predictions_output_path = "/Users/wangyangyang/Desktop/Finland/summer_job/home_kitchen/level_3/processed_files/test_predictions_original.csv"
...
# Function to get CPU and memory usage using psutil
def get_process_metrics():
    process = psutil.Process(os.getpid())
    cpu_usage = process.cpu_percent(interval=0.1)  # CPU usage over 100ms
...
for idx, input_value in enumerate(X_test_scaled):
    ...
    cpu_before, memory_before = get_process_metrics()
    ...
    cpu_after, memory_after = get_process_metrics()
...
# Print averages with memory in bytes
print(f"Average CPU Usage Before: {average_cpu_before:.2f}%")
print(f"Average Memory Usage Before: {average_memory_before:.2f} bytes")
print(f"Average CPU Usage After: {average_cpu_after:.2f}%")
print(f"Average Memory Usage After: {average_memory_after:.2f} bytes")
