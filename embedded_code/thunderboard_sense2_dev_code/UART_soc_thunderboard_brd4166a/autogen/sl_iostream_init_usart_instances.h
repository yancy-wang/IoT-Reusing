...
extern sl_iostream_t *sl_iostream_exp_handle;
extern sl_iostream_uart_t *sl_iostream_uart_exp_handle;
extern sl_iostream_instance_info_t sl_iostream_instance_exp_info;
