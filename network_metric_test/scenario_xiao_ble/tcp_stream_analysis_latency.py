...
def calculate_http_latency_and_packets(pcap_file):
    # 读取 pcap 文件
    capture = pyshark.FileCapture(pcap_file, display_filter="ip.addr == 87.92.45.224 && tcp.port ==5000")
...
# 使用示例
pcap_file = "/Users/wangyangyang/Desktop/Finland/summer_job/ubikampus/latency/scenario_xiao_ble/xiao_ble_csc.pcap"  # 替换为你的 PCAP 文件路径
output_csv = "/Users/wangyangyang/Desktop/Finland/summer_job/ubikampus/latency/scenario_xiao_ble/xiao_ble_csc.csv"  # 替换为你希望保存的 CSV 路径
